...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡I⚡", url="tg://settings"), InlineKeyboardButton("🤡TickTok😁", url="tg://settings")],
                    [InlineKeyboardButton("🥀II🥀", url="tg://settings"), InlineKeyboardButton("☠️Source Code☠️", url="https://t.me/batlolman/4")],
                    [InlineKeyboardButton("👺IIi👺", url="tg://settings")]
                ]
            ),
            disable_web_page_preview=True
        )
...
┃
┣⪼<b>𝙱𝙾𝚃-𝙽𝙰𝙼𝙴 : <a href='tg://settings'>🙀</a></b>
┣⪼<b>𝚄𝙿𝙳𝙰𝚃𝙴𝚉 : <a href='https://t.me/batlolman/4'>No-√Update</a></b>
┣⪼<b>𝚂𝚄𝙿𝙿𝙾𝚁𝚃 : <a href='tg://settings'>Support-urself</a></b>
┣⪼<b>𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙷𝙴𝚁𝚄𝙺𝙾</b>
┣⪼<b>𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚁𝙾𝙶𝚁𝙰𝙼</b>
┣⪼<b>𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 3</b>
┣⪼<b>𝚂𝙾𝚄𝚁𝙲𝙴-𝙲𝙾𝙳𝙴 : <a href='https://t.me/batlolman/4'>𝙵𝙸𝙻𝙴-𝚃𝙾-𝙻𝙸𝙽𝙺</a></b>
┣⪼<b>🥸BooM LaaA : <a href='https://t.me/IAmJustKiddingwitu/3'>MyJoke</a></b>
┃
<b>╰━━━━━━━〔🤖〕</b>""",
  parse_mode="html",
        disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("🤡TickTok😁", url="tg://settings"), InlineKeyboardButton("☠️Source Code☠️", url="https://t.me/IAmJustKiddingwitu/3")],
                [InlineKeyboardButton("LoL", url="https://t.me/batlolman/4")]
            ]
        )
    )
